...
public class FusionStats : Fusion.Behaviour {
  ...
  [SerializeField] [HideInInspector] UnityEngine.Canvas _canvas;
  ...
  void ResetInternal(
    ...
    var canv = GetComponentInChildren<UnityEngine.Canvas>();
    if (canv) {
  ...
  void GenerateGraphs() {
    ...
    _canvas = _canvasRT.gameObject.AddComponent<UnityEngine.Canvas>();
